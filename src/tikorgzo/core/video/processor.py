...
class VideoInfoProcessor:
    def validate_video_link(self, video_link: str) -> str:
        ...
        if re.search(VT_TIKTOK_VIDEO_LINK_REGEX, video_link):
            return self._get_normalized_url(video_link)
    ...
    def process_username(self, video_link: str) -> str | None:
    ...
    def _get_video_filename(self, video_id: int, username: str, date: datetime, filename_template: str | None) -> str:
    ...
    def _get_download_dir(self, custom_downloads_dir: str | None) -> pathlib.Path:
